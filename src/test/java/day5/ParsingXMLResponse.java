...
public class ParsingXMLResponse {
	...
	void testXMLResponse()
	{
		...
		//Same validations with Approach-2
	...
	void testXMLResponseBody()
	{
		...
		List<String> t=xml.getList("TravelerinformationResponse.travelers.Travelerinformation");
		Assert.assertEquals(t.size(),10);
		
		//Verify traveller name is presnt or not
		List<String> tName=xml.getList("TravelerinformationResponse.travelers.Travelerinformation.name");
